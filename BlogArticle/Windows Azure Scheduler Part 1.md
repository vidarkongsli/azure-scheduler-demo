...
![Scheduler item in Management Console](Windows Azure Scheduler-1-1.png)

Click on the *Scheduler* item, and select *New-->App Services-->Scheduler-->Custom Create*, which will bring up the following dialog:

![Selecting job collection for new job] (Windows Azure Scheduler-1-2.png)
...
![Defining job action] (Windows Azure Scheduler-1-3.png)
...
![Defining recurrence] (Windows Azure Scheduler-1-4.png)
...
![Creating a cloud project in Visual Studio] (Windows Azure Scheduler-1-5.png)
...
![Adding roles a cloud project] (Windows Azure Scheduler-1-6.png)
...
![Finding access keys for a storage service] (Windows Azure Scheduler-1-7.png)
...
![Copying a storage access key to the clipboard] (Windows Azure Scheduler-1-8.png)
...
![Publishing a cloud application from Visual Studio] (Windows Azure Scheduler-1-9.png)

Since we have no could service to deploy to, we choose to create a new one:

![Creating a cloud service to deploy to from Visual Studio] (Windows Azure Scheduler-1-10.png)

We use the default settings for the rest, and press *Publish*:

![Publish settings summary] (Windows Azure Scheduler-1-11.png)
...
![Viewing diagnostics log entries in Azure Storage] (Windows Azure Scheduler-1-12.png)
